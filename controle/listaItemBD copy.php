<?php
	...
	if($tipo == "comprador" OR $tipo == 'supadm' ){
		...
		if($resultado_id){
			...
			while($registro = mysqli_fetch_array($resultado_id, MYSQLI_ASSOC)){
				echo "<tr>
						<td id='".$registro['nome_item']."'>".$registro['nome_item']."</a></td>
						<td id='".$registro['descricao_item']."'>".$registro['descricao_item']."</td>
						<td id='".$registro['cod_mv']."'>".$registro['cod_mv']."</td>
					...
					echo "
					<script>$('.click-item').click(function(){
					...
					<script>$('.click-itemDel').click(function(){
